...
namespace PRTrackerUI.Models
{
    public class TrackerPullRequest
    {
        ...
        private readonly ITrackerPullRequest gitPullRequest;

        public TrackerPullRequest(ITrackerPullRequest gitPullRequest, ConcurrentDictionary<string, BitmapImage> avatarCache, AsyncCache<string, BitmapImage> avatarDownloadAsyncCache, TrackerQuery query)
        {
